const cases = [
  ...
  ['zh', '203', {actor:'新万金开发厅', object:'法定公告清单', stage:'无新增', eventDate:'2026-09-12', source:'官方公告清单', boundary:'没有新执行文件'}],
  ['en', '203', {actor:'Saemangeum agency', object:'statutory register', stage:'no addition', eventDate:'2026-09-12', source:'official notice register', boundary:'no new execution instrument'}],
  ['ko', '203', {actor:'새만금개발청', object:'고시공고 목록', stage:'추가 없음', eventDate:'2026-09-12', source:'공식 고시공고', boundary:'새 집행 문서 없음'}],
...
console.log(JSON.stringify({status: passed ? 'passed' : 'failed', records: cases.length, languages: 3, metrics: 3, required, failures, limitation:'Structural completeness does not establish native-language equivalence or reader comprehension.'}, null, 2));
