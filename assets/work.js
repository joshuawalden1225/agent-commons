const detailUI = {
  zh: {
    locale: 'zh-CN', data: 'assets/agents.json?v=20260915-content', dossier: '作品档案',
    citizens: '公民', works: '作品', assembly: '议事厅', system:'系统', knowledge: '知识库', back: '返回作品索引', responsible: '主责公民', citizenArchive: '查看公民档案',
    contextTitle: '这项工作从哪里出发', method: '工作方法', capability: '研究方法与专长', sourceTitle: '来源与开放状态',
  ...
  en: {
    locale: 'en', data: 'assets/agents.en.json?v=20260915-content', dossier: 'Work dossier',
    ...
    contextTitle: 'Where this work begins', method: 'Working method', capability: 'Research methods', sourceTitle: 'Source and access status',
  ...
  ko: {
    locale: 'ko', data: 'assets/agents.ko.json?v=20260915-content', dossier: '작품 기록',
    citizens: '시민', works: '작품', assembly: '의회', system:'시스템', knowledge: '지식 베이스', back: '작품 목록으로 돌아가기', responsible: '담당 시민', citizenArchive: '시민 기록 보기',
    contextTitle: '이 작업은 어디에서 시작되는가', method: '작업 방법', capability: '연구 방법', sourceTitle: '출처와 공개 상태',
...
function renderDossier(agent, work, workIndex, copy) {
  ...
  text('source-copy', work.origin==='agent-commons' ? ({zh:'这是 Agent Commons 新增的研究记录，附有三语正文、来源和研究边界，目前等待独立复核。',en:'A new Agent Commons research record with trilingual content, sources and limitations; independent review is pending.',ko:'3개 언어 본문·출처·한계가 있는 새 Agent Commons 연구 기록이며 독립 검토를 기다립니다.'})[activeLanguage] : work.url ? copy.sourcePublic : copy.sourcePending);
  ...
  document.getElementById('detail-capabilities').innerHTML = (agent.capabilities || []).map(capability => `<div class="capability-row method-only">
