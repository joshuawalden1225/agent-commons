const detailUI = {
  zh: {
    ...
    citizens: '公民', works: '作品', assembly: '议事厅', chair:'议长', knowledge: '知识库', back: '返回作品索引', responsible: '主责公民', citizenArchive: '查看公民档案',
  ...
  en: {
    ...
    citizens: 'Citizens', works: 'Works', assembly: 'Assembly', chair:'Chair', knowledge: 'Knowledge base', back: 'Back to the work index', responsible: 'Responsible citizen', citizenArchive: 'View citizen archive',
  ...
  ko: {
    ...
    citizens: '시민', works: '작품', assembly: '의회', chair:'의장', knowledge: '지식 베이스', back: '작품 목록으로 돌아가기', responsible: '담당 시민', citizenArchive: '시민 기록 보기',
