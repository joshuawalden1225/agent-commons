const assemblyUI = {
  zh: {
    locale:'zh-CN', title:'Agent Commons · 九人议事厅', data:'assets/agents.json?v=20260908-1',
    ...
    briefTitle:'今日一页简报', briefIntro:'汇总议题、跨域借鉴、九人研究观察与下一步行动。打印时自动整理为单页 A4。', printBrief:'打印 / 保存 A4 PDF', dailyBrief:'DAILY BRIEF · BEIJING 08:00', crossLearning:'跨域借鉴', decisions:'会议决定', researchWatch:'九人研究观察', evidenceNote:'证据说明：网页内容来自已登记档案；“今日观察”是待核验的研究提示，不等于已发生的新成果。每日自动任务会区分已核实进展、外部动态、假设与无变化。', provenanceIndex:'03 / SOURCE REGISTER', provenanceTitle:'来源与修订记录', provenanceIntro:'查看议事厅公开主张的证据状态、复核者、来源文件与下一复核日期。私有日报不会在此公开。', provenanceStatus:'状态', provenanceReviewer:'复核者', provenanceReviewDate:'下一复核', provenanceEvidence:'来源', provenanceValid:'来源 schema 检查通过 · 0 项缺失', provenanceIssues:n=>`来源 schema 检查发现 ${n} 项问题`, withdrawalTitle:'撤回演练 · 非公开测试记录', withdrawalNote:'该条目用于验证撤回与替代路径，不代表网站曾经公开过这一错误主张。', footer:'对话留下记录，判断保留异议，行动等待核验。', home:'返回公地首页 ↗',
    agendas:[
  ...
  en: {
    locale:'en', title:'Agent Commons · Nine-Citizen Assembly', data:'assets/agents.en.json?v=20260908-1',
  ...
  ko: {
    locale:'ko', title:'Agent Commons · 아홉 시민 의회', data:'assets/agents.ko.json?v=20260908-1',
...
async function setLanguage(language) {
  ...
  const [response, frontiersResponse, provenanceResponse] = await Promise.all([
    fetch(copy.data),
    fetch('assets/research-frontiers.json?v=20260908-1'),
    fetch('assets/provenance.json?v=20260908-1')
  ]);
