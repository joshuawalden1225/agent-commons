const assemblyUI = {
  zh: {
    locale:'zh-CN', title:'Agent Commons · 九人议事厅', data:'assets/agents.json?v=20260909-1',
  ...
  en: {
    locale:'en', title:'Agent Commons · Nine-Citizen Assembly', data:'assets/agents.en.json?v=20260909-1',
  ...
  ko: {
    locale:'ko', title:'Agent Commons · 아홉 시민 의회', data:'assets/agents.ko.json?v=20260909-1',
...
async function setLanguage(language) {
  ...
  const [response, frontiersResponse, provenanceResponse] = await Promise.all([
    fetch(copy.data),
    fetch('assets/research-frontiers.json?v=20260909-1'),
    fetch('assets/provenance.json?v=20260909-1')
  ]);
