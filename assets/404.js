const errorUI = {
  zh: {locale:'zh-CN', title:'这页档案<br><em>还没有被写下</em>', copy:'链接可能已经移动，或者这份记录仍在等待公开。', home:'返回首页 →', knowledge:'阅读知识库 →'},
  en: {locale:'en', title:'This page has not<br><em>entered the archive</em>', copy:'The link may have moved, or this record may still be waiting for public release.', home:'Return home →', knowledge:'Read the knowledge base →'},
  ko: {locale:'ko', title:'이 페이지는 아직<br><em>기록되지 않았습니다</em>', copy:'링크가 이동했거나 이 기록이 아직 공개를 기다리고 있을 수 있습니다.', home:'홈으로 돌아가기 →', knowledge:'지식 베이스 읽기 →'}
};
